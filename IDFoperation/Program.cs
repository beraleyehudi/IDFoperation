...
namespace IDFoperation
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            NewReport report3 = new NewReport(yechya2, "home");
            NewReport report4 = new NewReport(yechya2, "home");
            NewReport report5 = new NewReport(yechya2, "home");
            NewReport report6 = new NewReport(yechya3, "home");
